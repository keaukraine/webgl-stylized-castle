...
export const GLU = {
     ...
     */
    unProject: function (winX: number, winY: number, winZ: number, model: number[], proj: number[], view: number[], objPos: number[]): boolean {
        /** @type {Array.<number>} */
        var inp = [
            winX,
            winY,
     ...
     */
    multMatrixVec: function (matrix: number[], inp: number[], out: number[]) {
     ...
     */
    multMatrices: function (a: number[], b: number[], r: number[]) {
        for (var i = 0; i < 4; i = i + 1) {
     ...
     */
    invertMatrix: function (m: number[], invOut: number[]): boolean {
        /** @type {Array.<number>} */
        var inv = [];
